...
new BeerSlider(document.getElementById('beer-slider1'));
new BeerSlider(document.getElementById('beer-slider2'));
new BeerSlider(document.getElementById('beer-slider3'));
new BeerSlider(document.getElementById('beer-slider4'));
new BeerSlider(document.getElementById('beer-slider5'));
new BeerSlider(document.getElementById('beer-slider6'));
new BeerSlider(document.getElementById('beer-slider7'));
new BeerSlider(document.getElementById('beer-slider8'));
new BeerSlider(document.getElementById('beer-slider9'));
new BeerSlider(document.getElementById('beer-slider10'));

new BeerSlider(document.getElementById('retouching-slider1'));
new BeerSlider(document.getElementById('retouching-slider2'));
new BeerSlider(document.getElementById('retouching-slider3'));
new BeerSlider(document.getElementById('retouching-slider4'));
new BeerSlider(document.getElementById('retouching-slider5'));
new BeerSlider(document.getElementById('retouching-slider6'));
new BeerSlider(document.getElementById('retouching-slider7'));
new BeerSlider(document.getElementById('retouching-slider8'));
new BeerSlider(document.getElementById('retouching-slider9'));
new BeerSlider(document.getElementById('retouching-slider10'));
$(document).ready(function () {
	$('#re-popup1, #re-popup2, #re-popup3, #re-popup4, #re-popup5, #re-popup6, #re-popup7, #re-popup8, #re-popup9, #re-popup10, #re-popup11, #re-popup12, #re-popup13, #re-popup14, #re-popup15, #re-popup16, #re-popup17, #re-popup18, #re-popup19, #re-popup20').popup({
		transition: 'all 0.3s'
	});
	$('#popup1, #popup2, #popup3, #popup4, #popup5, #popup6, #popup7, #popup8, #popup9, #popup10, #popup11, #popup12, #popup13, #popup14, #popup15, #popup16, #popup17, #popup18, #popup19, #popup20').popup({
		transition: 'all 0.3s'
	});
	$('#popup-retouching1, #popup-retouching2, #popup-retouching3, #popup-retouching4, #popup-retouching5, #popup-retouching6, #popup-retouching7, #popup-retouching8, #popup-retouching9, #popup-retouching10, #popup-retouching11, #popup-retouching12, #popup-retouching13, #popup-retouching14, #popup-retouching15, #popup-retouching16, #popup-retouching17, #popup-retouching18, #popup-retouching19, #popup-retouching20').popup({
		transition: 'all 0.3s'
	});
	$('#popup-premium1, #popup-premium2, #popup-premium3, #popup-premium4, #popup-premium5, #popup-premium6, #popup-premium7, #popup-premium8, #popup-premium9, #popup-premium10, #popup-premium11, #popup-premium12, #popup-premium13, #popup-premium14, #popup-premium15, #popup-premium16, #popup-premium17, #popup-premium18, #popup-premium19, #popup-premium20').popup({
		transition: 'all 0.3s'
	});
});
/* ===== LOADER OVERLAY ===== */
